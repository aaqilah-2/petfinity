...
<div class="why-section">
    ...
    <div class="content">
        ...
        <div class="card">
            <img src="images/pet-care (2).png" alt="Experienced Caregivers">
...
<div class="feeding-section">
    <div class="video-container">
        <video class="feeding-video" src="images/welcomevideo.mp4" controls muted></video>
        <h2 class="video-title">Watch How Petfinity Can Make a Difference</h2>
        <div class="video-message">For all your petcare needs. Thank you for your support!</div>
    </div>
</div>

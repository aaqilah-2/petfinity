...
<body>
    ...
    <div class="container">
        <div class="left-panel">
            {{-- <img src="add-pet.png" alt="Petfinity Logo" style="margin-bottom: 2rem;">  --}}
            <h1>Welcome to Petfinity!</h1>
            <p>Your one stop place to manage all your pet boarding troubles and meet up with our new pets!</p>
            <button onclick="location.href='#'">Already have an account?</button>
            {{-- <img src="/mnt/data/regss.png" alt="Pet Clinic"> --}}
        </div>
